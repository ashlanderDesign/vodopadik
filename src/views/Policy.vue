<template>
  <div class="wrapper">
    ...
    <p>
      ...
      персональных данных, предпринимаемые Михайловым Иваном Сергеевичем (далее
      – Оператор).
    </p>
    <p>
    ...
    <p>
      ...
      может получить о посетителях веб-сайта www.santechnika-aqua.ru
    </p>
    ...
    <p>
      ...
      интернет по сетевому адресу www.santechnika-aqua.ru
    </p>
    <p>
    ...
    <p>
      2.10. Пользователь – любой посетитель веб-сайта www.santechnika-aqua.ru
    </p>
    <p>
